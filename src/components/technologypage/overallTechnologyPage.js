...
import { TechnologyPageImgSection } from "./technologyPageImgSection";
  ...
  return (
    <main class="mdHeight:mt-[5%] lgHeight:mt-[10%]">
      <li class="mt-6 py-1 lg:text-left lg:ml-[10%]  text-center text-[28px] font-Barlow ">
        <span class="opacity-50 text-secondaryColor">03</span>{" "}
        <span class=" ml-2 text-secondaryColor  tracking-[2.75px]">SPACE LAUNCH 101</span>
      </li>
      <div class=" lg:flex lg:flex-row-reverse lg:ml-[5%] lg:gap-[5%]">
        <TechnologyPageImgSection {...{ name }} currentImgUrl={ImageUrl} />
