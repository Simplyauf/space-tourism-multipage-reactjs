	...
	return (
		<>
			<main class="flex flex-col mt-6 mdHeight:mt-[12%] lgHeight:mt-[16%] md:flex md:flex-row md:mt-40 laptop:mt-20 md:justify-between md:w-[82%] md:mx-auto md:items-end">
				...
				<button class="hover:ring-[52px] hover:transition-all hover:duration-300 hover:ease-linear md:hover:ring-[72px] hover:ring-opacity-10 hover:ring-secondaryColor mx-auto mt-12 text-black bg-white w-40 h-40 rounded-[50%] text-[22px] tracking-[1.5px] font-normal lg:w-60 lg:h-60 lgHeight:w-72 lgHeight:h-72 md:w-48 md:h-48 explore-btn" onClick={handleExploreBtn}>
					EXPLORE
				</button>
			</main>
		</>
