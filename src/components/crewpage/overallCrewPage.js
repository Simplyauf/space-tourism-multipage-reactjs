		...
		<main class="lg:flex lg:flex-col lg:flex-grow mdHeight:mt-[9%] lgHeight:mt-[12%]">
			...
			<div class="lg:w-[80%] lg:flex items-start lg:justify-self-end lg:flex-grow lg:flex-row-reverse lg:mx-auto">
				<div class="mt-8 mx-auto w-[80%] h-[250px] tablet:h-[300px] border-opacity-50 border-b-2 border-white lg:border-transparent lg:w-[70%] lg:h-[420px] mdHeight:h-[460px] lgHeight:h-[500px] lg:mt-0 lg:self-end">
					<img class="max-w-[100%] h-[100%] mx-auto object-cover crew-img" src={images.png} alt="crew-img" />
				</div>
				...
				<article class="lg:w-[70%] mt-8 lg:flex lg:items-start lg:flex-col lg:mt-8 laptop:mt-12 lg:justify-between pb-4">
					...
					<article class="">
						<div class="text-center lg:text-left">
							<span class="uppercase opacity-50 text-secondaryColor crew-role lg:text-[30px] tracking-[1.15px]"> {role} </span>
						...
						<div class="w-[80%] lg:w-[70%] mx-auto mt-4 laptop:mt-[20px] lg:mx-0">
							<p class="text-center lg:text-left text-[16px] lg:text-[18px] laptop:text-[20px] leading-[30px] font-Barlow text-primaryColor crew-bio">{bio}</p>
						</div>
					</article>
				</article>
			</div>
